...
--
-- Hôte : 127.0.0.1
-- Généré le : mer. 03 jan. 2024 à 11:13
...
('Blova', 'Blova', 'Blova', 'Blova', 'France', 23, 'Blova');
...
(28, 'Blova', 'Blova', '33672772713', 'Blova@Blova', 1, 23);
...
INSERT INTO `delivery_addresses` (`id`, `adresse_id`, `customer_id`) VALUES
(46, 3, 1),
(47, 1, 1),
(48, 2, 2),
(49, 4, 2);
...
(21, '26', 'nino2', '$2y$10$XAyEWY468VssOP8epyEOX.QA2WCi2fB41.9RyFc2e2MhplX3LVXc.'),
(22, '27', 'nino1', '$2y$10$BH0xJlfaKTg1E0tmq7/0yOUdd17vPwcpBiGnpaWTln/pW2xY0G2jm'),
(23, '28', 'Blova', '$2y$10$3vdtE4/JlTZ1m/7eKES/Zu.LY251tXDALBuSrwCJuSPIcIkhoyg5y');
